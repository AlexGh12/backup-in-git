...
class BackupDBs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'BackupInGit:dbs';
     ...
     * @var string
     */
    protected $description = 'El comando descarga las copias de las bases de datos y las guarda en la carpeta ../backup_{APP_NAME}/db y sube cambios a un repositorio de git [Estructura Datalux]';
